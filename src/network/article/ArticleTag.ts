...
import {ArticleTagReply} from '../../reply';

/**
 * Represents an {@link ArticleTag}
 * @extends {BaseClass}
 */
export class ArticleTag extends BaseClass implements IArticleTag {
  ...
  public constructor(client: Client, data: ArticleTagReply) {
    super(client);
